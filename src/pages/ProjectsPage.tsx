...
export function ProjectsPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-ink antialiased flex flex-col justify-between">
      <div>
        <Header />
        
        <main className="mx-auto max-w-[1200px] px-6 py-16 sm:px-8 lg:px-10 lg:py-24">
          <SectionHeading
            eyebrow="PORTFOLIO / SELECTED WORK"
            title="All Product Case Studies"
            description="Explore the comprehensive archive of developer projects, spanning front-end, back-end, and full-stack system architectures."
          />
